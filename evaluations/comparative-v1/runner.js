...
import { comparisonCases, comparisonArms } from './cases.js';
...
export function createComparisonHandler({ authenticate = authenticateSupabaseRequest, fetchImpl = globalThis.fetch,
  ...
  return async (req, res) => {
    ...
    if (!fixture || !comparisonArms.includes(arm) || !['resume', 'letter'].includes(kind)
    ...
    const start = now();
    const result = { version: 1, experiment: 'comparative-v1', caseId, arm, kind, attempt: 1,
