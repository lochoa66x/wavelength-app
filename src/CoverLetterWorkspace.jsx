...
export function CoverLetterWorkspace({
  ...
  return (
    <section ref={workspaceRef} aria-labelledby="cover-letter-heading" data-cover-letter-workspace tabIndex={-1} style={{ marginTop: 20, padding: 18, border: `1px solid ${C.border}`, borderRadius: 16, background: C.bgCard, scrollMarginTop: 96 }}>
      ...
      <style>{`@media print { [data-cover-letter-workspace] > :not([data-cover-letter-preview]) { display: none !important; } .document-controls { display: none !important; } [data-cover-letter-preview] { box-shadow: none !important; border-radius: 0 !important; } } @media screen and (max-width: 640px) { [data-cover-letter-preview], [data-resume-preview] { padding: 24px !important; min-height: 0 !important; } }`}</style>
