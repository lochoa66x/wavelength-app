...
const paragraphs = [
 {id:"opening",purpose:"opening",text:"My consulting work focuses on training and guidance.",evidence_refs:[source],requirement_refs:[job.responsibilities[0]],explanation:"Training evidence.",evidence_match:"direct"},
